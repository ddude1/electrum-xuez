...
from electrum_xuez_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_xuez.mnemonic import Mnemonic
        from electrum_xuez.old_mnemonic import words as old_wordlist
