...
from electrum_xuez.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_xuez import bitcoin
from electrum_xuez.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        ...
        try:
            uri = electrum_xuez.util.parse_URI(text, self.app.on_pr)
        except:
    ...
    def do_save(self):
        ...
        from electrum_xuez.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_xuez.util import create_URI
