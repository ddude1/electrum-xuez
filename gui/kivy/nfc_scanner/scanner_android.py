...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum-xuez.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum-xuez"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum-xuez:externalType",
                '',
                data)
        return extRecord
