...
from electrum_xuez.bitcoin import TYPE_ADDRESS
from electrum_xuez import WalletStorage, Wallet
from electrum_xuez_gui.kivy.i18n import _
from electrum_xuez.paymentrequest import InvoiceStore
from electrum_xuez.util import profiler, InvalidPassword
from electrum_xuez.plugins import run_hook
from electrum_xuez.util import format_satoshis, format_satoshis_plain
...
#Factory.register('InstallWizard', module='electrum_xuez_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_xuez_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_xuez_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_xuez_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_xuez_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_xuez_gui.kivy.uix.screens')
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_xuez.bitcoin import NetworkConstants
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'mXUEZ')
    ...
    def on_qr(self, data):
        from electrum_xuez.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_xuez.transaction import Transaction
        from electrum_xuez.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_xuez.util import format_time
    ...
    def on_start(self):
        ...
        # bind intent for xuez: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def load_wallet_by_name(self, path):
        ...
        if wallet:
            ...
            Logger.debug('Electrum-XUEZ: Wallet not found. Launching install wizard')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_xuez_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_xuez_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_xuez_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_xuez_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-xuez.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-XUEZ', message,
                            app_icon=icon, app_name='Electrum-XUEZ')
        except ImportError:
