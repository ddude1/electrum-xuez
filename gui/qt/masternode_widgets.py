...
from electrum_xuez import bitcoin
from electrum_xuez.bitcoin import COIN
from electrum_xuez.i18n import _
from electrum_xuez.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 1000 XUEZ output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 1000 XUEZ output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 1000 XUEZ was sent to'))
...
class MasternodeEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        form.addRow(_('Collateral XUEZ Output:'), self.vin_edit)
...
class MasternodeOutputsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        desc = ' '.join(['Use this tab to scan for and choose a collateral payment for your masternode.',
            'A valid collateral payment is exactly 1000 XUEZ.'])
        desc = QLabel(_(desc))
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 1000 XUEZ outputs were found.'))
...
class SignAnnounceWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        form = QFormLayout()
        form.addRow(_('Alias:'), self.alias_edit)
        form.addRow(_('Collateral XUEZ Output:'), self.collateral_edit)
