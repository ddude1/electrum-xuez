...
from electrum_xuez.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum_xuez.transaction import deserialize, Transaction
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Xuez Testnet" if TESTNET else "Xuez"
