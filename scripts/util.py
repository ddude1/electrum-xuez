import select, time, electrum_xuez, Queue
from electrum_xuez import Connection, Interface, SimpleConfig
from electrum_xuez.network import filter_protocol, parse_servers
from collections import defaultdict

# electrum_xuez.util.set_verbosity(1)
